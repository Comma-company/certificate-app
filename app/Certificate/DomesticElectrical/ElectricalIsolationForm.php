...
class ElectricalIsolationForm
{
    public static function createPdf($certificate)
    {
        ...
        $html = view('dashboard.form.template.domestic_electrical.Electrical_Isolation_Form.index', [
            'data' => $data,
            'formData' =>   $formData,
        ...
        $invoice->AddPage('L');
        $page_2 = view('dashboard.form.template.domestic_electrical.Electrical_Isolation_Form.note', [
            'data' => $certificate,
            'formData' => $formData,
            'cert_attachments' =>$cert_attachments,
