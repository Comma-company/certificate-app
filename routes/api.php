...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::prefix('certificates')->group(function () {
        ...
        Route::get('{id}/pdf', [CertificateController::class, 'getPdfForm'])->middleware(['auth:sanctum','user.subscribe']);

        Route::post('create', [CertificateController::class, 'store'])->middleware(['auth:sanctum', 'user.subscribe']);
        Route::post('{id}/notes/create', [CertificateController::class, 'storeNote'])->middleware(['auth:sanctum', 'user.subscribe']);
        Route::post('{note_id}/notes/update', [CertificateController::class, 'updateNote'])->middleware(['auth:sanctum', 'user.subscribe']);
        Route::post('{id}/files/{file_id}/delete', [CertificateController::class, 'deleteFileImage'])->middleware(['auth:sanctum', 'user.subscribe']);
        Route::post('{id}/notes/delete', [CertificateController::class, 'deleteNote'])->middleware(['auth:sanctum', 'user.subscribe']);
        Route::post('{id}/update', [CertificateController::class, 'update'])->middleware(['auth:sanctum', 'user.subscribe']);
        Route::post('{id}/update-status', [CertificateController::class, 'updateStatus'])->middleware(['auth:sanctum', 'user.subscribe']);
        Route::post('send-email/{certificate_id}', [CertificateController::class, 'sendEmail'])->middleware(['auth:sanctum', 'user.subscribe']);
        //Route::get('form-data/invoice', [FormDataController::class, 'invoice'])->middleware('auth:sanctum');
        Route::get('{id}/get-attachments', [CertificateAttachmentController::class, 'get'])->middleware(['auth:sanctum', 'user.subscribe']);
        ...
        Route::get('get-forms',[FormValidController::class,'getAllForms'])->middleware(['auth:sanctum']);
    });
