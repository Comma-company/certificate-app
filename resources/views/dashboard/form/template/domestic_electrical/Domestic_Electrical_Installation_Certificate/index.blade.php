                     ...
                     PART 1 : DETAILS OF THE CONTRACTOR, CLIENT AND INSTALLATION
                      ...
                      <div style="width: 32.3%;float: left;">
                              ...
                              <div style="padding:0 10px;">
                                <h6 style="margin:5px 0px ;font-size: 12px;font-weight: 100;">
                                  ...
                                  <h6 style="margin:5px 0px;font-size: 12px;font-weight: 100;">
                                    Address:
                                  <span style="font-weight: bold;padding:3px 20px">{{$user->number_street_name.', '.$user->city}}</span>
                                  </h6>
                                  <h6 style="margin:5px 0px ;font-size: 12px;font-weight: 100;">
                      ...
                      <div style="width: 32.3%; float: left;">
                        ...
                        <div style="padding:0 10px;">
                              ...
                              <h6 style="margin:5px 0px ;font-size: 12px;font-weight: 100;">
                                Address:<span style="font-weight: bold;padding:3px 20px">{{$data->customer->number_street_name.', '.$data->customer->city}}</span>
