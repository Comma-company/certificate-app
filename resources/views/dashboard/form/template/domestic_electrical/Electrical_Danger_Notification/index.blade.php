                      ...
                      <div style="width: 32.3%;border-right: 1px solid #000000;height: 240px; float: left;">
                        ...
                        <div style="padding:0 10px;">
                          ...
                          <h6 style="margin:15px 5px;font-size: 12px;font-weight: 100;">Postcode :  {{ $data->customer->sites->first()->postal_code }}
                                <span style="margin-left: 170px;">Tel No : {{  $data->customer->sites->siteContact ? $data->customer->sites->siteContact()->first()->phone : " " }} </span>
                          </h6>
                          <h6 style="margin:15px 5px;font-size: 12px;font-weight: 100;">Email : {{ $data->customer->sites->siteContact? $data->customer->sites->siteContact()->first()->email : "" }} </h6>
                        </div>
