                ...
                <table style="width: 100%;">
                    <thead>
                        <tr style="background-color: yellow;">
                            <th colspan="3" style="text-transform: uppercase; text-align: left; color: black; font-weight: 700; font-size: 20px; margin: 0; padding: 5px; ">Strength test details</th>
                        </tr>
                      
                    </thead>
                    <tbody  >
                        <tr>
                            <td style=" padding-left: 3px; padding-top:3px; padding-bottom:3px; width: 50%;">
      ...
      <div class="table-content" style="padding: 0px;">
         <div class="pdf-table" style="display: block; ">
              <table style="width: 100%;">
                  <thead>
                      <tr style="background-color: yellow;">
                          <th colspan="3" style="text-transform: uppercase; text-align: left; color: black; font-weight: 700; font-size: 20px; margin: 0; padding: 5px; ">Tightness test details</th>
                      </tr>
                    
                  </thead>
                  <tbody  >
                      <tr>
                          <td style=" padding-left: 1px; padding-top:1px; padding-bottom:1px; width: 50%;">
      ...
      <div class="table-content" style="padding: 0px;">
         <div class="pdf-table" style="display: block; ">
              <table style="width: 100%;">
                  <thead>
                      <tr style="background-color: yellow;">
                          <th colspan="3" style="text-transform: uppercase; text-align: left; color: black; font-weight: 700; font-size: 20px; margin: 0; padding: 5px; ">Purging procedure details</th>
                      </tr>
      ...
      <div class="table-content" style="padding: 0px;">
         <div class="pdf-table" style="display: block; ">
              <table style="width: 100%;">
                  <thead>
                      <tr style="background-color: yellow;">
                          <th colspan="3" style="text-transform: uppercase; text-align: left; color: black; font-weight: 700; font-size: 20px; margin: 0; padding: 5px; ">Indicate work undertaken</th>
                      </tr>
      ...
      <div class="table-content" style="padding: 0px;">
         <div class="pdf-table" style="display: block; ">
              <table style="width: 100%;">
                  <thead>
                      <tr style="background-color: yellow;">
                          <th  style=" width: 50%; text-transform: uppercase; text-align: left; color: black; font-weight: 700; font-size: 20px; margin: 0; padding: 5px; ">Declaration of Gas Safety</th>
                          <th  style=" width: 50%; text-transform: uppercase; text-align: right; color: black; font-weight: 700; font-size: 20px; margin: 0; padding: 5px; ">DATE :{{ getvalue('engineer_date', $formData['part_declaration']) }}</th>
                  ...
                  <tbody  >
                      <tr>
                          <td colspan="2" style=" padding-left: 1px; padding-top:1px; padding-bottom:1px; ">
                    ...
                    <tr>
                        <td colspan="2" style=" padding-left: 1px; padding-top:15px; padding-bottom:15px; ">
      ...
      <div class="table-content" style="padding: 0px;">
         <div class="pdf-table" style="display: block; ">
              <table style="width: 100%;">
                  <thead>
                      <tr style="background-color: yellow;">
                          <th  style=" width: 50%; text-transform: uppercase; text-align: left; color: black; font-weight: 700; font-size: 20px; margin: 0; padding: 5px; ">Notification of unsafe gas installation</th>
                          <th  style=" width: 50%; text-transform: uppercase; text-align: right; color: black; font-weight: 700; font-size: 20px; margin: 0; padding: 5px; ">DATE :{{ getvalue('engineer_date', $formData['part_declaration']) }} </th>
                  ...
                  <tbody  >
                    ...
                    <tr>
                        <td colspan="2" style=" padding-left: 1px; padding-top:15px; padding-bottom:5px; ">
